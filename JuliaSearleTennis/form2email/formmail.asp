...
<%	'**************************************************************************
	...
	'fromAddr   = "info@\\web-123win\winpackage23\tenniscoaching.london\www.tenniscoaching.london\web\content\form2email\setup_script.cgi"
    fromAddr = "adam.tyson@hotmail.co.uk"
    'fromAddr   = Request.Form("Email")
    recipients = "juliasearle31@gmail.com"


	'allowedHosts      = Array("www.\\web-123win\winpackage23\tenniscoaching.london\www.tenniscoaching.london\web\content\form2email\setup_script.cgi", "\\web-123win\winpackage23\tenniscoaching.london\www.tenniscoaching.london\web\content\form2email\setup_script.cgi")
	allowedHosts = Array()
